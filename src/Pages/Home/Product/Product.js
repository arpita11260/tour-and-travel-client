    ...
    return (
        <Grid item xs={12} md={4}>
            <Paper elevation={3} className="product">
                <img src={product.img} alt="" width="90%" height="200px" style={{ marginTop: "10px" }} />
                ...
                <Button onClick={() => { handleClick(product._id) }} type="contained" style={{ color: "white", backgroundColor: "#F63E7B", padding: "10px", width: "90%" }} sx={{ my: 2 }}>Book Now</Button>
            </Paper>
        </Grid>
    );
};
